...
// Endpoint to generate study questions based on text
app.post("/api/study-help/generate-questions", async (req, res) => {
...
async function setupApp() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`StudyPlanner backend running on http://0.0.0.0:${PORT}`);
  });
}
